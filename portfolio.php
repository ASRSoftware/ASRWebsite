    ...
    <section id="portfolio" class="container main">    
        <ul class="gallery col-4">
          ...
          <br/>  <li>
            ...
            <li>
                <div class="preview">
                    <img alt=" " src="images/portfolio/thumb/AvniPhotocom.jpg">
                    <div class="overlay">
                    </div>
                    <div class="links">
                        <a class="portfolio" href="AvniPhotocom.html"><i class="icon-eye-open"></i></a><a href="#"><i class="icon-link"></i></a>                                
                    </div>
                </div>
                <div class="desc">
                    <h5>AvniPhotocom</h5>
            ...
            <li>
                <div class="preview">
                    <img alt=" " src="images/portfolio/thumb/BobbyK.jpg">
                    <div class="overlay">
                    </div>
                    <div class="links">
                        <a class="portfolio" href="BobbyK.html"><i class="icon-eye-open"></i></a><a href="#"><i class="icon-link"></i></a>                                
                    </div>
                </div>
                <div class="desc">
                    <h5>BobbyK</h5>
                ...
                <div id="modal-6" class="modal hide fade">
                    <a class="close-modal" href="javascript:;" data-dismiss="modal" aria-hidden="true"><i class="icon-remove"></i></a>
                    <div class="modal-body">
                        <img src="images/portfolio/full/BobbyK.jpg" alt=" " width="100%" style="max-height:400px">
                    </div>
                </div>                 
            </li>
            <!--/Item 6-->                 
