        ...
        <div class="row-fluid">
            <div class="span4">
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading">Web Design & Development</h4>
            ...
            <div class="span4">
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading">Website Maintenance</h4>
        ...
        <div class="row-fluid">
            ...
            <div class="span4">
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading">Web Hosting and Domain Names</h4>
                        <p>Web hosting and domain names are very important aspects of website ownership.Swift Creations provides high quality and reliable web hosting as well as domain name registration services.</p>
                    </div>
                </div>
            </div>
        </div>
